      ...
      <form ref={ref}>
        ...
        <div className="flex justify-around">
          <button
            onClick={handleSaved}
            type="submit"
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 w-20">
            保存
          </button>
          <button
            onClick={props.onCancel}
            type="button"
            className="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 w-20">
            取消
          </button>
        </div>
      </form>
